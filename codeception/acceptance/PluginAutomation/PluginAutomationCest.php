...
class Store_Plugin
{
    ...
    public function install()
    {
        ...
        $this->I->assertFileExists($this->config['plugin_realdir'].'/'.$this->plugin['code'].'/composer.json');
    ...
    {
        $this->I->assertFileNotExists($this->config['plugin_realdir'].'/'.$this->plugin['code'].'/composer.json');
