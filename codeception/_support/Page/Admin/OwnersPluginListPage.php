...
class OwnersPluginListPage extends AbstractAdminNewPage
{
    ...
    {
        $this->tester->click(['xpath' => '//span[contains(text(),"' . $name . '")]/ancestor::tr/td/div/div/a[i[@data-original-title="有効化"]]']);
    ...
    {
        $this->tester->click(['xpath' => '//span[contains(text(),"' . $name . '")]/ancestor::tr/td/div/div/a[i[@data-original-title="無効化"]]']);
    ...
    public function uninstall($name)
    {
        ...
        $this->tester->waitForText("削除が完了しました。", 60, "#officialPluginDeleteModal");
    ...
    public function authenByKey($key)
    {
        ...
        $this->tester->click(['xpath' => '//button[@type="submit"]']);
